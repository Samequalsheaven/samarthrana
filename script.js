...
const setupAudioPlayer = () => {
    ...
    // Try multiple paths for local and GitHub compatibility
    const audioPath = window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1'
        ? 'assets/audio/Akai.m4a'
        : 'pf code/assets/audio/Akai.m4a';
